...
namespace SI_SearchDemoSolution.Controllers
{
    public class MusiciansController : Controller
    {
        ...
        private SelectList GetAllInstrumentsSelectList()
        {
            ...
            List<Models.Instrument> instrumentList = _context.Instruments.ToList();

            //add a dummy entry so the user can select all instruments
            Models.Instrument SelectNone = new Models.Instrument() { InstrumentId = 0, Name = "All Instruments" };
