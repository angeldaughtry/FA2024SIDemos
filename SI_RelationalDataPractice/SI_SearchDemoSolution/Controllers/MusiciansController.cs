...
using Instrument = SI_SearchDemoSolution.Models.Instrument;
...
namespace SI_SearchDemoSolution.Controllers
{
    public class MusiciansController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            //TODO: ADD .INCLUDE STATEMENT TO SHOW INSTRUMENT
            return View( _context.Musicians.ToList());
        }
            ...
            public async Task<IActionResult> Details(int? id)
        {
            ...
            //TODO: add .Include statement to display a musician's instrument
