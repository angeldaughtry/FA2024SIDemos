...
namespace SI_SearchDemoSolution.Migrations
{
    ...
    [Migration("20250401145457_Setup")]
    partial class Setup
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SI_SearchDemoSolution.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SI_SearchDemoSolution.Models.Instrument", b =>
                {
            ...
            modelBuilder.Entity("SI_SearchDemoSolution.Models.Musician", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SI_SearchDemoSolution.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SI_SearchDemoSolution.Models.Musician", b =>
                {
                    b.HasOne("SI_SearchDemoSolution.Models.Instrument", "Instrument")
                        .WithMany("Musicians")
