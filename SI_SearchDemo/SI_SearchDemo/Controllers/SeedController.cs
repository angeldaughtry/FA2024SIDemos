...
namespace SI_SearchDemo.Controllers
{
    public class SeedController : Controller
    {
        ...
        public IActionResult SeedInstruments()
        {
            try
            {
                Seeding.SeedInstruments.SeedAllInstruments(_db);
            }
            catch (Exception ex)
            {
        ...
        public IActionResult SeedMusicians()
        {
            try
            {
                Seeding.SeedMusicians.SeedAllMusicians(_db); 
            }
            catch (Exception ex)
            {
